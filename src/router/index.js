...
export default new Router({
  routes: [
    ...
    { path: '/emitOn', component: emitOn },
    { path: '/arrayTest', component: arrayTest },
    { path: '/lazyLoad', component: lazyLoad },
    { path: '/qrcode', component: qrcode },
    { path: '/Loadmore', component: Loadmore },
    { path: '/RouterTst/', component: RouterTst, children:[
        { path: '/rutTst/:id', component: rutTst, }
      ]
    },
    ...
    { path:'/slidePanel', component: slidePanel, },
    ...
    { path: '/Unpopular', component: Unpopular },
